	...
	/* Public Interface - May be used in end-application: */
		...
		/* Type Defines: */
			...
			typedef struct
			{
				...
				wchar_t  UnicodeString[1];
				#else
				uint16_t UnicodeString[1];/**< String data, as unicode characters (alternatively,
			...
			typedef struct
			{
				...
				uint8_t bDescriptorType; /**< Type of the descriptor, either a value in \ref USB_DescriptorTypes_t
				                          ...
				                          */
				uint16_t bString[1]; /**< String data, as unicode characters (alternatively, string language IDs).
